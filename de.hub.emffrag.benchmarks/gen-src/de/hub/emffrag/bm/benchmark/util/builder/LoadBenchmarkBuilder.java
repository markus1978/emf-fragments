...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object ' <em><b>de.hub.emffrag.bm.benchmark.LoadBenchmark</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class LoadBenchmarkBuilder implements de.hub.emffrag.bm.benchmark.util.builder.IBenchmarkBuilder<de.hub.emffrag.bm.benchmark.LoadBenchmark> {
   ...
   * @see #newLoadBenchmarkBuilder()
   */
  private LoadBenchmarkBuilder() {
  }

  /**
   * This method creates a new instance of the LoadBenchmarkBuilder.
   * @return new instance of the LoadBenchmarkBuilder
   */
  public static LoadBenchmarkBuilder newLoadBenchmarkBuilder() {
    return new LoadBenchmarkBuilder();
  }

  /**
   * This method can be used to override attributes of the builder. It constructs a new builder and copies the current values to it.
   */
  public LoadBenchmarkBuilder but() {
    LoadBenchmarkBuilder _builder = newLoadBenchmarkBuilder();
  ...
  /**
   * This method constructs the final de.hub.emffrag.bm.benchmark.LoadBenchmark type.
   * @return new instance of the de.hub.emffrag.bm.benchmark.LoadBenchmark type
   */
  public de.hub.emffrag.bm.benchmark.LoadBenchmark build() {
    final de.hub.emffrag.bm.benchmark.LoadBenchmark _newInstance = de.hub.emffrag.bm.benchmark.BenchmarkFactory.eINSTANCE.createLoadBenchmark();
  ...
  public LoadBenchmarkBuilder withFrag2(Boolean p_frag2) {
    m_frag2 = p_frag2;
    m_featureFrag2Set = true;
    return this;
  }

  public LoadBenchmarkBuilder withLoads(Integer p_loads) {
    m_loads = p_loads;
    m_featureLoadsSet = true;
    return this;
  }

  public LoadBenchmarkBuilder withMaxActiveFagments(Integer p_maxActiveFagments) {
    m_maxActiveFagments = p_maxActiveFagments;
    m_featureMaxActiveFagmentsSet = true;
    return this;
  }

  public LoadBenchmarkBuilder withMaxWeakFragments(Integer p_maxWeakFragments) {
    m_maxWeakFragments = p_maxWeakFragments;
    m_featureMaxWeakFragmentsSet = true;
    return this;
  }

  public LoadBenchmarkBuilder withPModelName(java.lang.String p_pModelName) {
    m_pModelName = p_pModelName;
    m_featurePModelNameSet = true;
    return this;
  }

  public LoadBenchmarkBuilder withPSourceXmiURI(java.lang.String p_pSourceXmiURI) {
    m_pSourceXmiURI = p_pSourceXmiURI;
    m_featurePSourceXmiURISet = true;
    return this;
  }

  public LoadBenchmarkBuilder withRMemoryUsage(long p_rMemoryUsage) {
    m_rMemoryUsage = p_rMemoryUsage;
    m_featureRMemoryUsageSet = true;
    return this;
  }

  public LoadBenchmarkBuilder withRNumberOfObjects(Integer p_rNumberOfObjects) {
    m_rNumberOfObjects = p_rNumberOfObjects;
    m_featureRNumberOfObjectsSet = true;
    return this;
  }

  public LoadBenchmarkBuilder withRTime(long p_rTime) {
    m_rTime = p_rTime;
    m_featureRTimeSet = true;
    return this;
  }

  public LoadBenchmarkBuilder withRemarks(java.lang.String p_remarks) {
    m_remarks = p_remarks;
    m_featureRemarksSet = true;
    return this;
  }

  public LoadBenchmarkBuilder withUnloads(Integer p_unloads) {
    m_unloads = p_unloads;
    m_featureUnloadsSet = true;
    return this;
  }

  public LoadBenchmarkBuilder withWeakLoads(Integer p_weakLoads) {
    m_weakLoads = p_weakLoads;
    m_featureWeakLoadsSet = true;
    return this;
  }

  public LoadBenchmarkBuilder withWeakUnloads(Integer p_weakUnloads) {
