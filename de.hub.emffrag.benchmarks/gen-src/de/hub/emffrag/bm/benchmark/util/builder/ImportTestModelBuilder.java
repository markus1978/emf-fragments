...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object ' <em><b>de.hub.emffrag.bm.benchmark.ImportTestModel</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ImportTestModelBuilder implements de.hub.emffrag.bm.benchmark.util.builder.IBenchmarkBuilder<de.hub.emffrag.bm.benchmark.ImportTestModel> {
   ...
   * @see #newImportTestModelBuilder()
   */
  private ImportTestModelBuilder() {
  }

  /**
   * This method creates a new instance of the ImportTestModelBuilder.
   * @return new instance of the ImportTestModelBuilder
   */
  public static ImportTestModelBuilder newImportTestModelBuilder() {
    return new ImportTestModelBuilder();
  }

  /**
   * This method can be used to override attributes of the builder. It constructs a new builder and copies the current values to it.
   */
  public ImportTestModelBuilder but() {
    ImportTestModelBuilder _builder = newImportTestModelBuilder();
  ...
  /**
   * This method constructs the final de.hub.emffrag.bm.benchmark.ImportTestModel type.
   * @return new instance of the de.hub.emffrag.bm.benchmark.ImportTestModel type
   */
  public de.hub.emffrag.bm.benchmark.ImportTestModel build() {
    final de.hub.emffrag.bm.benchmark.ImportTestModel _newInstance = de.hub.emffrag.bm.benchmark.BenchmarkFactory.eINSTANCE.createImportTestModel();
  ...
  public ImportTestModelBuilder withFragmentSize(Integer p_fragmentSize) {
    m_fragmentSize = p_fragmentSize;
    m_featureFragmentSizeSet = true;
    return this;
  }

  public ImportTestModelBuilder withLoads(Integer p_loads) {
    m_loads = p_loads;
    m_featureLoadsSet = true;
    return this;
  }

  public ImportTestModelBuilder withMaxActiveFagments(Integer p_maxActiveFagments) {
    m_maxActiveFagments = p_maxActiveFagments;
    m_featureMaxActiveFagmentsSet = true;
    return this;
  }

  public ImportTestModelBuilder withMaxWeakFragments(Integer p_maxWeakFragments) {
    m_maxWeakFragments = p_maxWeakFragments;
    m_featureMaxWeakFragmentsSet = true;
    return this;
  }

  public ImportTestModelBuilder withModelSize(Integer p_modelSize) {
    m_modelSize = p_modelSize;
    m_featureModelSizeSet = true;
    return this;
  }

  public ImportTestModelBuilder withPModelName(java.lang.String p_pModelName) {
    m_pModelName = p_pModelName;
    m_featurePModelNameSet = true;
    return this;
  }

  public ImportTestModelBuilder withRMemoryUsage(long p_rMemoryUsage) {
    m_rMemoryUsage = p_rMemoryUsage;
    m_featureRMemoryUsageSet = true;
    return this;
  }

  public ImportTestModelBuilder withRNumberOfObjects(Integer p_rNumberOfObjects) {
    m_rNumberOfObjects = p_rNumberOfObjects;
    m_featureRNumberOfObjectsSet = true;
    return this;
  }

  public ImportTestModelBuilder withRTime(long p_rTime) {
    m_rTime = p_rTime;
    m_featureRTimeSet = true;
    return this;
  }

  public ImportTestModelBuilder withRemarks(java.lang.String p_remarks) {
    m_remarks = p_remarks;
    m_featureRemarksSet = true;
    return this;
  }

  public ImportTestModelBuilder withUnloads(Integer p_unloads) {
    m_unloads = p_unloads;
    m_featureUnloadsSet = true;
    return this;
  }

  public ImportTestModelBuilder withWeakLoads(Integer p_weakLoads) {
    m_weakLoads = p_weakLoads;
    m_featureWeakLoadsSet = true;
    return this;
  }

  public ImportTestModelBuilder withWeakUnloads(Integer p_weakUnloads) {
