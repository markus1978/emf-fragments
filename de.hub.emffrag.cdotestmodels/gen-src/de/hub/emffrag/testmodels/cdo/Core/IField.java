 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.IField#getConstant <em>Constant</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.IField#getIsEnumConstant <em>Is Enum Constant</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.IField#getTypeSignature <em>Type Signature</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.IField#getIsVolatile <em>Is Volatile</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.IField#getIsTransient <em>Is Transient</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIField()
 * @model
 * @generated
 */
public interface IField extends IMember {
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIField_Constant()
	 * @model unique="false" dataType="de.hub.emffrag.testmodels.cdo.PrimitiveTypes.String" ordered="false"
	 * @generated
	 */
	String getConstant();

	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.cdo.Core.IField#getConstant <em>Constant</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIField_IsEnumConstant()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.cdo.Core.IField#getIsEnumConstant <em>Is Enum Constant</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIField_TypeSignature()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.cdo.Core.IField#getTypeSignature <em>Type Signature</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIField_IsVolatile()
	 * @model unique="false" dataType="de.hub.emffrag.testmodels.cdo.PrimitiveTypes.Boolean" required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.cdo.Core.IField#getIsVolatile <em>Is Volatile</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIField_IsTransient()
	 * @model unique="false" dataType="de.hub.emffrag.testmodels.cdo.PrimitiveTypes.Boolean" required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.cdo.Core.IField#getIsTransient <em>Is Transient</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
