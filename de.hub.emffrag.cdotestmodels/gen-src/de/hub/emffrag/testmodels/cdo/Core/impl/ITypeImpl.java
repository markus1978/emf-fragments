 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.ITypeImpl#getFullyQualifiedName <em>Fully Qualified Name</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.ITypeImpl#getFullyQualifiedParametrizedName <em>Fully Qualified Parametrized Name</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.ITypeImpl#getInitializers <em>Initializers</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.ITypeImpl#getFields <em>Fields</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.ITypeImpl#getMethods <em>Methods</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.ITypeImpl#getTypes <em>Types</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.ITypeImpl#getTypeParameters <em>Type Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
