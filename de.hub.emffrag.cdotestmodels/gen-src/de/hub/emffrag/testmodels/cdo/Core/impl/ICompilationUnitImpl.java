 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.ICompilationUnitImpl#getAllType <em>All Type</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.ICompilationUnitImpl#getImports <em>Imports</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.ICompilationUnitImpl#getTypes <em>Types</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.ICompilationUnitImpl#getPrimary <em>Primary</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.ICompilationUnitImpl#getAst <em>Ast</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
