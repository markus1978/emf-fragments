 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.IMember#getJavadocRange <em>Javadoc Range</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.IMember#getNameRange <em>Name Range</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIMember()
 * @model abstract="true"
 * @generated
 */
public interface IMember extends IJavaElement, ISourceReference {
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIMember_JavadocRange()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.cdo.Core.IMember#getJavadocRange <em>Javadoc Range</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIMember_NameRange()
	 * @model containment="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.cdo.Core.IMember#getNameRange <em>Name Range</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
