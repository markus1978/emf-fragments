...
import de.hub.emffrag.testmodels.cdo.Core.BinaryPackageFragmentRoot;
import de.hub.emffrag.testmodels.cdo.Core.CoreFactory;
import de.hub.emffrag.testmodels.cdo.Core.CorePackage;
import de.hub.emffrag.testmodels.cdo.Core.IClassFile;
import de.hub.emffrag.testmodels.cdo.Core.ICompilationUnit;
import de.hub.emffrag.testmodels.cdo.Core.IField;
import de.hub.emffrag.testmodels.cdo.Core.IImportDeclaration;
import de.hub.emffrag.testmodels.cdo.Core.IInitializer;
import de.hub.emffrag.testmodels.cdo.Core.IJavaElement;
import de.hub.emffrag.testmodels.cdo.Core.IJavaModel;
import de.hub.emffrag.testmodels.cdo.Core.IJavaProject;
import de.hub.emffrag.testmodels.cdo.Core.IMember;
import de.hub.emffrag.testmodels.cdo.Core.IMethod;
import de.hub.emffrag.testmodels.cdo.Core.IPackageFragment;
import de.hub.emffrag.testmodels.cdo.Core.IPackageFragmentRoot;
import de.hub.emffrag.testmodels.cdo.Core.ISourceRange;
import de.hub.emffrag.testmodels.cdo.Core.ISourceReference;
import de.hub.emffrag.testmodels.cdo.Core.IType;
import de.hub.emffrag.testmodels.cdo.Core.ITypeParameter;
import de.hub.emffrag.testmodels.cdo.Core.ITypeRoot;
import de.hub.emffrag.testmodels.cdo.Core.Modifiers;
import de.hub.emffrag.testmodels.cdo.Core.Parameter;
import de.hub.emffrag.testmodels.cdo.Core.PhysicalElement;
import de.hub.emffrag.testmodels.cdo.Core.SourcePackageFragmentRoot;

import de.hub.emffrag.testmodels.cdo.DOM.DOMPackage;

import de.hub.emffrag.testmodels.cdo.DOM.impl.DOMPackageImpl;
...
public class CorePackageImpl extends EPackageImpl implements CorePackage {
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void createDeAnnotations() {
		...
		addAnnotation
		  (getIPackageFragment_ClassFiles(), 
		   source, 
		   new String[] {
			 "Fragmentation", "true"
		   });		
		addAnnotation
		  (getIPackageFragment_CompilationUnits(), 
		   source, 
		   new String[] {
			 "Fragmentation", "true"
		   });
