 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.IJavaProjectImpl#getPath <em>Path</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.IJavaProjectImpl#getIsReadOnly <em>Is Read Only</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.IJavaProjectImpl#getPackageFragmentRoots <em>Package Fragment Roots</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.IJavaProjectImpl#getExternalPackageFragmentRoots <em>External Package Fragment Roots</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.IJavaProjectImpl#getRequiredProjects <em>Required Projects</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
