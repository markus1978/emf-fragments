 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.IJavaProject#getPackageFragmentRoots <em>Package Fragment Roots</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.IJavaProject#getExternalPackageFragmentRoots <em>External Package Fragment Roots</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.IJavaProject#getRequiredProjects <em>Required Projects</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIJavaProject()
 * @model
 * @generated
 */
public interface IJavaProject extends IJavaElement, PhysicalElement {
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIJavaProject_PackageFragmentRoots()
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIJavaProject_ExternalPackageFragmentRoots()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.Core.CorePackage#getIJavaProject_RequiredProjects()
	 * @model
	 * @generated
	 */
