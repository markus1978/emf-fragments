 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.IMethodImpl#getReturnType <em>Return Type</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.IMethodImpl#getIsConstructor <em>Is Constructor</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.IMethodImpl#getIsMainMethod <em>Is Main Method</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.IMethodImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.Core.impl.IMethodImpl#getExceptionTypes <em>Exception Types</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
