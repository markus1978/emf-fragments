 ...
 */
package de.hub.emffrag.testmodels.cdo.testmodel.impl;

import de.hub.emffrag.testmodels.cdo.testmodel.Contents;
import de.hub.emffrag.testmodels.cdo.testmodel.TestModelFactory;
import de.hub.emffrag.testmodels.cdo.testmodel.TestModelPackage;
import de.hub.emffrag.testmodels.cdo.testmodel.TestObject;
...
public class TestModelPackageImpl extends EPackageImpl implements TestModelPackage {
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.testmodel.TestModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(containerEClass, de.hub.emffrag.testmodels.cdo.testmodel.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_Contents(), this.getContents(), null, "contents", null, 0, -1, de.hub.emffrag.testmodels.cdo.testmodel.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_FragmentedContents(), this.getContents(), null, "fragmentedContents", null, 0, -1, de.hub.emffrag.testmodels.cdo.testmodel.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
