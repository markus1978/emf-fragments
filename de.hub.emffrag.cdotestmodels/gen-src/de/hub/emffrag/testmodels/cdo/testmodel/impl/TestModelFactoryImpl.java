...
public class TestModelFactoryImpl extends EFactoryImpl implements TestModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TestModelPackage.CONTAINER: return (EObject)createContainer();
			case TestModelPackage.CONTENTS: return (EObject)createContents();
	 ...
	 * @generated
	 */
	public de.hub.emffrag.testmodels.cdo.testmodel.Container createContainer() {
