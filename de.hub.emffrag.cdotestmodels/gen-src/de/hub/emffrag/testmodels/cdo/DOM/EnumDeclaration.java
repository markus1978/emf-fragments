 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.DOM.EnumDeclaration#getSuperInterfaceTypes <em>Super Interface Types</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.DOM.EnumDeclaration#getEnumConstants <em>Enum Constants</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.cdo.DOM.DOMPackage#getEnumDeclaration()
 * @model
 * @generated
 */
public interface EnumDeclaration extends AbstractTypeDeclaration {
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.DOM.DOMPackage#getEnumDeclaration_SuperInterfaceTypes()
	 ...
	 * The list contents are of type {@link de.hub.emffrag.testmodels.cdo.DOM.EnumConstantDeclaration}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.DOM.DOMPackage#getEnumDeclaration_EnumConstants()
	 * @model containment="true"
	 * @generated
	 */
