 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.cdo.DOM.Comment#getAlternateRoot <em>Alternate Root</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.cdo.DOM.DOMPackage#getComment()
 * @model abstract="true"
 * @generated
 */
public interface Comment extends ASTNode {
	 ...
	 * @see de.hub.emffrag.testmodels.cdo.DOM.DOMPackage#getComment_AlternateRoot()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.cdo.DOM.Comment#getAlternateRoot <em>Alternate Root</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
