 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.AssertStatementImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.AssertStatementImpl#getMessage <em>Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssertStatementImpl extends StatementImpl implements AssertStatement {
	...
	public Expression getExpression() {
		if (expression != null && expression.eIsProxy()) {
			...
			if (expression != oldExpression) {
				...
				NotificationChain msgs = oldExpression.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.ASSERT_STATEMENT__EXPRESSION, null, null);
				if (newExpression.eInternalContainer() == null) {
					msgs = newExpression.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.ASSERT_STATEMENT__EXPRESSION, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.ASSERT_STATEMENT__EXPRESSION, oldExpression, expression));
			}
		}
		return expression;
	}
	...
	public void setExpression(Expression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.ASSERT_STATEMENT__EXPRESSION, null, msgs);
	...
	public Expression getMessage() {
		if (message != null && message.eIsProxy()) {
			...
			message = (Expression)eResolveProxy(oldMessage);
			if (message != oldMessage) {
				InternalEObject newMessage = (InternalEObject)message;
				NotificationChain msgs = oldMessage.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.ASSERT_STATEMENT__MESSAGE, null, null);
				if (newMessage.eInternalContainer() == null) {
					msgs = newMessage.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.ASSERT_STATEMENT__MESSAGE, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.ASSERT_STATEMENT__MESSAGE, oldMessage, message));
			}
		}
		return message;
	}
	 ...
	 * @generated
	 */
	public Expression basicGetMessage() {
		return message;
	}
	...
	public void setMessage(Expression newMessage) {
		if (newMessage != message) {
			NotificationChain msgs = null;
			if (message != null)
				msgs = ((InternalEObject)message).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.ASSERT_STATEMENT__MESSAGE, null, msgs);
			if (newMessage != null)
