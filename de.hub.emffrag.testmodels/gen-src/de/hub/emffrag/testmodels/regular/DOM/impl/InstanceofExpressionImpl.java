 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.InstanceofExpressionImpl#getLeftOperand <em>Left Operand</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.InstanceofExpressionImpl#getRightOperand <em>Right Operand</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InstanceofExpressionImpl extends ExpressionImpl implements InstanceofExpression {
	...
	public Expression getLeftOperand() {
		if (leftOperand != null && leftOperand.eIsProxy()) {
			...
			if (leftOperand != oldLeftOperand) {
				InternalEObject newLeftOperand = (InternalEObject)leftOperand;
				NotificationChain msgs = oldLeftOperand.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.INSTANCEOF_EXPRESSION__LEFT_OPERAND, null, null);
				if (newLeftOperand.eInternalContainer() == null) {
					msgs = newLeftOperand.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.INSTANCEOF_EXPRESSION__LEFT_OPERAND, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.INSTANCEOF_EXPRESSION__LEFT_OPERAND, oldLeftOperand, leftOperand));
			}
		}
		return leftOperand;
	}
	...
	public void setLeftOperand(Expression newLeftOperand) {
		if (newLeftOperand != leftOperand) {
			...
			if (leftOperand != null)
				msgs = ((InternalEObject)leftOperand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.INSTANCEOF_EXPRESSION__LEFT_OPERAND, null, msgs);
	...
	public Type getRightOperand() {
		if (rightOperand != null && rightOperand.eIsProxy()) {
			...
			rightOperand = (Type)eResolveProxy(oldRightOperand);
			if (rightOperand != oldRightOperand) {
				InternalEObject newRightOperand = (InternalEObject)rightOperand;
				NotificationChain msgs = oldRightOperand.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.INSTANCEOF_EXPRESSION__RIGHT_OPERAND, null, null);
				if (newRightOperand.eInternalContainer() == null) {
					msgs = newRightOperand.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.INSTANCEOF_EXPRESSION__RIGHT_OPERAND, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.INSTANCEOF_EXPRESSION__RIGHT_OPERAND, oldRightOperand, rightOperand));
			}
		}
		return rightOperand;
	}
	 ...
	 * @generated
	 */
	public Type basicGetRightOperand() {
		return rightOperand;
	}
	...
	public NotificationChain basicSetRightOperand(Type newRightOperand, NotificationChain msgs) {
		Type oldRightOperand = rightOperand;
	...
	public void setRightOperand(Type newRightOperand) {
		if (newRightOperand != rightOperand) {
			...
			if (rightOperand != null)
				msgs = ((InternalEObject)rightOperand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.INSTANCEOF_EXPRESSION__RIGHT_OPERAND, null, msgs);
