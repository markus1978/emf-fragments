 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ForStatementImpl#getBody <em>Body</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ForStatementImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ForStatementImpl#getInitializers <em>Initializers</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ForStatementImpl#getUpdaters <em>Updaters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForStatementImpl extends StatementImpl implements ForStatement {
	...
	public Statement getBody() {
		if (body != null && body.eIsProxy()) {
			...
			if (body != oldBody) {
				...
				NotificationChain msgs = oldBody.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.FOR_STATEMENT__BODY, null, null);
				if (newBody.eInternalContainer() == null) {
					msgs = newBody.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.FOR_STATEMENT__BODY, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.FOR_STATEMENT__BODY, oldBody, body));
			}
		}
		return body;
	}
	...
	public Expression getExpression() {
		if (expression != null && expression.eIsProxy()) {
			...
			if (expression != oldExpression) {
				...
				NotificationChain msgs = oldExpression.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.FOR_STATEMENT__EXPRESSION, null, null);
				if (newExpression.eInternalContainer() == null) {
					msgs = newExpression.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.FOR_STATEMENT__EXPRESSION, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.FOR_STATEMENT__EXPRESSION, oldExpression, expression));
			}
		}
		return expression;
	}
	...
	public EList<Expression> getInitializers() {
		if (initializers == null) {
			initializers = new EObjectContainmentEList.Resolving<Expression>(Expression.class, this, DOMPackage.FOR_STATEMENT__INITIALIZERS);
		}
		return initializers;
	}
	...
	public EList<Expression> getUpdaters() {
		if (updaters == null) {
			updaters = new EObjectContainmentEList.Resolving<Expression>(Expression.class, this, DOMPackage.FOR_STATEMENT__UPDATERS);
		}
		return updaters;
	}
