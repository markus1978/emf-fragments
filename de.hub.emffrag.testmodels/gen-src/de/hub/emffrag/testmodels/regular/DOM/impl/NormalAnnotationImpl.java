 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.NormalAnnotationImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NormalAnnotationImpl extends AnnotationImpl implements NormalAnnotation {
	...
	public EList<MemberValuePair> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList.Resolving<MemberValuePair>(MemberValuePair.class, this, DOMPackage.NORMAL_ANNOTATION__VALUES);
		}
		return values;
	}
