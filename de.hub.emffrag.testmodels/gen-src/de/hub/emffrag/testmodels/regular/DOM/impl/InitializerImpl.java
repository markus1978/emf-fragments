 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.InitializerImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InitializerImpl extends BodyDeclarationImpl implements Initializer {
	...
	public Block getBody() {
		if (body != null && body.eIsProxy()) {
			...
			if (body != oldBody) {
				...
				NotificationChain msgs = oldBody.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.INITIALIZER__BODY, null, null);
				if (newBody.eInternalContainer() == null) {
					msgs = newBody.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.INITIALIZER__BODY, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.INITIALIZER__BODY, oldBody, body));
			}
		}
		return body;
	}
	...
	public void setBody(Block newBody) {
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.INITIALIZER__BODY, null, msgs);
			if (newBody != null)
