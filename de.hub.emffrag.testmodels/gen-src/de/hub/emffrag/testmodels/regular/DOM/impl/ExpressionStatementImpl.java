 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ExpressionStatementImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public Expression getExpression() {
		if (expression != null && expression.eIsProxy()) {
			...
			if (expression != oldExpression) {
				...
				NotificationChain msgs = oldExpression.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.EXPRESSION_STATEMENT__EXPRESSION, null, null);
				if (newExpression.eInternalContainer() == null) {
					msgs = newExpression.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.EXPRESSION_STATEMENT__EXPRESSION, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.EXPRESSION_STATEMENT__EXPRESSION, oldExpression, expression));
			}
		}
		return expression;
	}
