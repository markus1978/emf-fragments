 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.TypeLiteralImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeLiteralImpl extends ExpressionImpl implements TypeLiteral {
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				...
				NotificationChain msgs = oldType.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.TYPE_LITERAL__TYPE, null, null);
				if (newType.eInternalContainer() == null) {
					msgs = newType.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.TYPE_LITERAL__TYPE, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.TYPE_LITERAL__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Type newType) {
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.TYPE_LITERAL__TYPE, null, msgs);
			if (newType != null)
