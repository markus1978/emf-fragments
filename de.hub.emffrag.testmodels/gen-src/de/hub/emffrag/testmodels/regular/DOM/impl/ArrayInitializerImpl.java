 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ArrayInitializerImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayInitializerImpl extends ExpressionImpl implements ArrayInitializer {
	...
	public EList<Expression> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList.Resolving<Expression>(Expression.class, this, DOMPackage.ARRAY_INITIALIZER__EXPRESSIONS);
		}
		return expressions;
	}
