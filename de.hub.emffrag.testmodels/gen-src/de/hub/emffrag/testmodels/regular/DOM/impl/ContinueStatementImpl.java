 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ContinueStatementImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public SimpleName getLabel() {
		if (label != null && label.eIsProxy()) {
			...
			if (label != oldLabel) {
				...
				NotificationChain msgs = oldLabel.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.CONTINUE_STATEMENT__LABEL, null, null);
				if (newLabel.eInternalContainer() == null) {
					msgs = newLabel.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.CONTINUE_STATEMENT__LABEL, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.CONTINUE_STATEMENT__LABEL, oldLabel, label));
			}
		}
		return label;
	}
