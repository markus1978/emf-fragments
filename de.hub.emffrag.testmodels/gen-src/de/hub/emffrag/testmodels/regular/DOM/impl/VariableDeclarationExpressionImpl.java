 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.VariableDeclarationExpressionImpl#getFragments <em>Fragments</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.VariableDeclarationExpressionImpl#getModifiers <em>Modifiers</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.VariableDeclarationExpressionImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableDeclarationExpressionImpl extends ExpressionImpl implements VariableDeclarationExpression {
	...
	public EList<VariableDeclarationFragment> getFragments() {
		if (fragments == null) {
			fragments = new EObjectContainmentEList.Resolving<VariableDeclarationFragment>(VariableDeclarationFragment.class, this, DOMPackage.VARIABLE_DECLARATION_EXPRESSION__FRAGMENTS);
		}
		return fragments;
	}
	...
	public EList<ExtendedModifier> getModifiers() {
		if (modifiers == null) {
			modifiers = new EObjectContainmentEList.Resolving<ExtendedModifier>(ExtendedModifier.class, this, DOMPackage.VARIABLE_DECLARATION_EXPRESSION__MODIFIERS);
		}
		return modifiers;
	}
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				...
				NotificationChain msgs = oldType.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.VARIABLE_DECLARATION_EXPRESSION__TYPE, null, null);
				if (newType.eInternalContainer() == null) {
					msgs = newType.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.VARIABLE_DECLARATION_EXPRESSION__TYPE, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.VARIABLE_DECLARATION_EXPRESSION__TYPE, oldType, type));
			}
		}
		return type;
	}
