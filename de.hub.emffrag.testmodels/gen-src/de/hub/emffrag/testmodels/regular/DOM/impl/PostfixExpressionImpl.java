 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.PostfixExpressionImpl#getOperand <em>Operand</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.PostfixExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PostfixExpressionImpl extends ExpressionImpl implements PostfixExpression {
	...
	public Expression getOperand() {
		if (operand != null && operand.eIsProxy()) {
			...
			if (operand != oldOperand) {
				...
				NotificationChain msgs = oldOperand.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.POSTFIX_EXPRESSION__OPERAND, null, null);
				if (newOperand.eInternalContainer() == null) {
					msgs = newOperand.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.POSTFIX_EXPRESSION__OPERAND, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.POSTFIX_EXPRESSION__OPERAND, oldOperand, operand));
			}
		}
		return operand;
	}
	...
	public void setOperand(Expression newOperand) {
		if (newOperand != operand) {
			...
			if (operand != null)
				msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.POSTFIX_EXPRESSION__OPERAND, null, msgs);
			if (newOperand != null)
	...
	public void setOperator(PostfixExpressionOperatorKind newOperator) {
		PostfixExpressionOperatorKind oldOperator = operator;
		operator = newOperator == null ? OPERATOR_EDEFAULT : newOperator;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DOMPackage.POSTFIX_EXPRESSION__OPERATOR, oldOperator, operator));
	}
