 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.SuperConstructorInvocationImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.SuperConstructorInvocationImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.SuperConstructorInvocationImpl#getTypeArguments <em>Type Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SuperConstructorInvocationImpl extends StatementImpl implements SuperConstructorInvocation {
	...
	public EList<Expression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList.Resolving<Expression>(Expression.class, this, DOMPackage.SUPER_CONSTRUCTOR_INVOCATION__ARGUMENTS);
		}
		return arguments;
	}
	...
	public Expression getExpression() {
		if (expression != null && expression.eIsProxy()) {
			...
			if (expression != oldExpression) {
				...
				NotificationChain msgs = oldExpression.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.SUPER_CONSTRUCTOR_INVOCATION__EXPRESSION, null, null);
				if (newExpression.eInternalContainer() == null) {
					msgs = newExpression.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.SUPER_CONSTRUCTOR_INVOCATION__EXPRESSION, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.SUPER_CONSTRUCTOR_INVOCATION__EXPRESSION, oldExpression, expression));
			}
		}
		return expression;
	}
	...
	public EList<Type> getTypeArguments() {
		if (typeArguments == null) {
			typeArguments = new EObjectContainmentEList.Resolving<Type>(Type.class, this, DOMPackage.SUPER_CONSTRUCTOR_INVOCATION__TYPE_ARGUMENTS);
		}
