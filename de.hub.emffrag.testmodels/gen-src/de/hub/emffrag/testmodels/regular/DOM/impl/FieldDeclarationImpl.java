 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.FieldDeclarationImpl#getFragments <em>Fragments</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.FieldDeclarationImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FieldDeclarationImpl extends BodyDeclarationImpl implements FieldDeclaration {
	...
	public EList<VariableDeclarationFragment> getFragments() {
		if (fragments == null) {
			fragments = new EObjectContainmentEList.Resolving<VariableDeclarationFragment>(VariableDeclarationFragment.class, this, DOMPackage.FIELD_DECLARATION__FRAGMENTS);
		}
		return fragments;
	}
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				...
				NotificationChain msgs = oldType.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.FIELD_DECLARATION__TYPE, null, null);
				if (newType.eInternalContainer() == null) {
					msgs = newType.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.FIELD_DECLARATION__TYPE, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.FIELD_DECLARATION__TYPE, oldType, type));
			}
		}
		return type;
	}
