 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.SingleVariableDeclarationImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.SingleVariableDeclarationImpl#getVarargs <em>Varargs</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.SingleVariableDeclarationImpl#getModifiers <em>Modifiers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SingleVariableDeclarationImpl extends VariableDeclarationImpl implements SingleVariableDeclaration {
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				...
				NotificationChain msgs = oldType.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.SINGLE_VARIABLE_DECLARATION__TYPE, null, null);
				if (newType.eInternalContainer() == null) {
					msgs = newType.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.SINGLE_VARIABLE_DECLARATION__TYPE, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.SINGLE_VARIABLE_DECLARATION__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Type newType) {
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.SINGLE_VARIABLE_DECLARATION__TYPE, null, msgs);
			if (newType != null)
	...
	public void setVarargs(Boolean newVarargs) {
		...
		varargs = newVarargs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DOMPackage.SINGLE_VARIABLE_DECLARATION__VARARGS, oldVarargs, varargs));
	}
	...
	public EList<ExtendedModifier> getModifiers() {
		if (modifiers == null) {
			modifiers = new EObjectContainmentEList.Resolving<ExtendedModifier>(ExtendedModifier.class, this, DOMPackage.SINGLE_VARIABLE_DECLARATION__MODIFIERS);
		}
		return modifiers;
	}
