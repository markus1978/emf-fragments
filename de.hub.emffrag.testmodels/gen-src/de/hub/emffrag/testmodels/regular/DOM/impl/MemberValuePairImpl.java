 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.MemberValuePairImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.MemberValuePairImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MemberValuePairImpl extends ASTNodeImpl implements MemberValuePair {
	...
	public SimpleName getName() {
		if (name != null && name.eIsProxy()) {
			...
			if (name != oldName) {
				...
				NotificationChain msgs = oldName.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.MEMBER_VALUE_PAIR__NAME, null, null);
				if (newName.eInternalContainer() == null) {
					msgs = newName.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.MEMBER_VALUE_PAIR__NAME, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.MEMBER_VALUE_PAIR__NAME, oldName, name));
			}
		}
		return name;
	}
	...
	public void setName(SimpleName newName) {
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.MEMBER_VALUE_PAIR__NAME, null, msgs);
			if (newName != null)
	...
	public Expression getValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				...
				NotificationChain msgs = oldValue.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.MEMBER_VALUE_PAIR__VALUE, null, null);
				if (newValue.eInternalContainer() == null) {
					msgs = newValue.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.MEMBER_VALUE_PAIR__VALUE, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.MEMBER_VALUE_PAIR__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(Expression newValue) {
		if (newValue != value) {
			NotificationChain msgs = null;
			if (value != null)
				msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.MEMBER_VALUE_PAIR__VALUE, null, msgs);
			if (newValue != null)
