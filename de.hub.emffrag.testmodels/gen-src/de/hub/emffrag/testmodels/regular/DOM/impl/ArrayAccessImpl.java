 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ArrayAccessImpl#getArray <em>Array</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ArrayAccessImpl#getIndex <em>Index</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayAccessImpl extends ExpressionImpl implements ArrayAccess {
	...
	public Expression getArray() {
		if (array != null && array.eIsProxy()) {
			...
			array = (Expression)eResolveProxy(oldArray);
			if (array != oldArray) {
				InternalEObject newArray = (InternalEObject)array;
				NotificationChain msgs = oldArray.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.ARRAY_ACCESS__ARRAY, null, null);
				if (newArray.eInternalContainer() == null) {
					msgs = newArray.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.ARRAY_ACCESS__ARRAY, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.ARRAY_ACCESS__ARRAY, oldArray, array));
			}
		}
		return array;
	}
	 ...
	 * @generated
	 */
	public Expression basicGetArray() {
		return array;
	}
	...
	public void setArray(Expression newArray) {
		if (newArray != array) {
			...
			if (array != null)
				msgs = ((InternalEObject)array).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.ARRAY_ACCESS__ARRAY, null, msgs);
			if (newArray != null)
	...
	public Expression getIndex() {
		if (index != null && index.eIsProxy()) {
			...
			if (index != oldIndex) {
				...
				NotificationChain msgs = oldIndex.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.ARRAY_ACCESS__INDEX, null, null);
				if (newIndex.eInternalContainer() == null) {
					msgs = newIndex.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.ARRAY_ACCESS__INDEX, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.ARRAY_ACCESS__INDEX, oldIndex, index));
			}
		}
		return index;
	}
	...
	public void setIndex(Expression newIndex) {
		if (newIndex != index) {
			NotificationChain msgs = null;
			if (index != null)
				msgs = ((InternalEObject)index).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.ARRAY_ACCESS__INDEX, null, msgs);
			if (newIndex != null)
