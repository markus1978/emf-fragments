 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ParameterizedTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ParameterizedTypeImpl#getTypeArguments <em>Type Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterizedTypeImpl extends TypeImpl implements ParameterizedType {
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				...
				NotificationChain msgs = oldType.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.PARAMETERIZED_TYPE__TYPE, null, null);
				if (newType.eInternalContainer() == null) {
					msgs = newType.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.PARAMETERIZED_TYPE__TYPE, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.PARAMETERIZED_TYPE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Type newType) {
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.PARAMETERIZED_TYPE__TYPE, null, msgs);
			if (newType != null)
	...
	public EList<Type> getTypeArguments() {
		if (typeArguments == null) {
			typeArguments = new EObjectContainmentEList.Resolving<Type>(Type.class, this, DOMPackage.PARAMETERIZED_TYPE__TYPE_ARGUMENTS);
		}
