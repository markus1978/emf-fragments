 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.MemberRefImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.MemberRefImpl#getQualifier <em>Qualifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MemberRefImpl extends ASTNodeImpl implements MemberRef {
	...
	public SimpleName getName() {
		if (name != null && name.eIsProxy()) {
			...
			if (name != oldName) {
				...
				NotificationChain msgs = oldName.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.MEMBER_REF__NAME, null, null);
				if (newName.eInternalContainer() == null) {
					msgs = newName.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.MEMBER_REF__NAME, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.MEMBER_REF__NAME, oldName, name));
			}
		}
		return name;
	}
	...
	public void setName(SimpleName newName) {
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.MEMBER_REF__NAME, null, msgs);
			if (newName != null)
	...
	public Name getQualifier() {
		if (qualifier != null && qualifier.eIsProxy()) {
			...
			if (qualifier != oldQualifier) {
				...
				NotificationChain msgs = oldQualifier.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.MEMBER_REF__QUALIFIER, null, null);
				if (newQualifier.eInternalContainer() == null) {
					msgs = newQualifier.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.MEMBER_REF__QUALIFIER, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.MEMBER_REF__QUALIFIER, oldQualifier, qualifier));
			}
		}
		return qualifier;
	}
	...
	public void setQualifier(Name newQualifier) {
		if (newQualifier != qualifier) {
			NotificationChain msgs = null;
			if (qualifier != null)
				msgs = ((InternalEObject)qualifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.MEMBER_REF__QUALIFIER, null, msgs);
