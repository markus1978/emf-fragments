 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.SuperMethodInvocationImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.SuperMethodInvocationImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.SuperMethodInvocationImpl#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.SuperMethodInvocationImpl#getTypeArguments <em>Type Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SuperMethodInvocationImpl extends ExpressionImpl implements SuperMethodInvocation {
	...
	public EList<Expression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList.Resolving<Expression>(Expression.class, this, DOMPackage.SUPER_METHOD_INVOCATION__ARGUMENTS);
		}
		return arguments;
	}
	...
	public Name getName() {
		if (name != null && name.eIsProxy()) {
			...
			if (name != oldName) {
				...
				NotificationChain msgs = oldName.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.SUPER_METHOD_INVOCATION__NAME, null, null);
				if (newName.eInternalContainer() == null) {
					msgs = newName.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.SUPER_METHOD_INVOCATION__NAME, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.SUPER_METHOD_INVOCATION__NAME, oldName, name));
			}
		}
		return name;
	}
	...
	public Name getQualifier() {
		if (qualifier != null && qualifier.eIsProxy()) {
			...
			if (qualifier != oldQualifier) {
				...
				NotificationChain msgs = oldQualifier.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DOMPackage.SUPER_METHOD_INVOCATION__QUALIFIER, null, null);
				if (newQualifier.eInternalContainer() == null) {
					msgs = newQualifier.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DOMPackage.SUPER_METHOD_INVOCATION__QUALIFIER, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DOMPackage.SUPER_METHOD_INVOCATION__QUALIFIER, oldQualifier, qualifier));
			}
		}
		return qualifier;
	}
	...
	public EList<Type> getTypeArguments() {
		if (typeArguments == null) {
			typeArguments = new EObjectContainmentEList.Resolving<Type>(Type.class, this, DOMPackage.SUPER_METHOD_INVOCATION__TYPE_ARGUMENTS);
		}
