 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ConstructorInvocationImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.ConstructorInvocationImpl#getTypeArguments <em>Type Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstructorInvocationImpl extends StatementImpl implements ConstructorInvocation {
	...
	public EList<Expression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList.Resolving<Expression>(Expression.class, this, DOMPackage.CONSTRUCTOR_INVOCATION__ARGUMENTS);
		}
		return arguments;
	}
	...
	public EList<Type> getTypeArguments() {
		if (typeArguments == null) {
			typeArguments = new EObjectContainmentEList.Resolving<Type>(Type.class, this, DOMPackage.CONSTRUCTOR_INVOCATION__TYPE_ARGUMENTS);
		}
