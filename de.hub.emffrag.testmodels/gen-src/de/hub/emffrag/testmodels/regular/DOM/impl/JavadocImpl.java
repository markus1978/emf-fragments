 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.DOM.impl.JavadocImpl#getTags <em>Tags</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JavadocImpl extends CommentImpl implements Javadoc {
	...
	public EList<TagElement> getTags() {
		if (tags == null) {
			tags = new EObjectContainmentEList.Resolving<TagElement>(TagElement.class, this, DOMPackage.JAVADOC__TAGS);
		}
		return tags;
	}
