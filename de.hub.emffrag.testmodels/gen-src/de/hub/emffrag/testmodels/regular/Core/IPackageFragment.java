 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.Core.IPackageFragment#getIsDefaultPackage <em>Is Default Package</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.Core.IPackageFragment#getPackageFragmentRoot <em>Package Fragment Root</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.Core.IPackageFragment#getClassFiles <em>Class Files</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.Core.IPackageFragment#getCompilationUnits <em>Compilation Units</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.regular.Core.CorePackage#getIPackageFragment()
 * @model
 * @generated
 */
public interface IPackageFragment extends IJavaElement, PhysicalElement {
	 ...
	 * @see de.hub.emffrag.testmodels.regular.Core.CorePackage#getIPackageFragment_IsDefaultPackage()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.regular.Core.IPackageFragment#getIsDefaultPackage <em>Is Default Package</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.hub.emffrag.testmodels.regular.Core.IPackageFragmentRoot#getPackageFragments <em>Package Fragments</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.emffrag.testmodels.regular.Core.CorePackage#getIPackageFragment_PackageFragmentRoot()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.regular.Core.IPackageFragment#getPackageFragmentRoot <em>Package Fragment Root</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.hub.emffrag.testmodels.regular.Core.IClassFile}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.emffrag.testmodels.regular.Core.CorePackage#getIPackageFragment_ClassFiles()
	 ...
	 * The list contents are of type {@link de.hub.emffrag.testmodels.regular.Core.ICompilationUnit}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.emffrag.testmodels.regular.Core.CorePackage#getIPackageFragment_CompilationUnits()
	 * @model containment="true" resolveProxies="true"
	 *        annotation="de.hub.emfhbase Fragmentation='true'"
	 * @generated
	 */
