 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.regular.Core.impl.PhysicalElementImpl#getPath <em>Path</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.regular.Core.impl.PhysicalElementImpl#getIsReadOnly <em>Is Read Only</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class PhysicalElementImpl extends EObjectImpl implements PhysicalElement {
	/**
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.PHYSICAL_ELEMENT__PATH, oldPath, path));
	}
	...
	public void setIsReadOnly(Boolean newIsReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.PHYSICAL_ELEMENT__IS_READ_ONLY, oldIsReadOnly, isReadOnly));
	}
