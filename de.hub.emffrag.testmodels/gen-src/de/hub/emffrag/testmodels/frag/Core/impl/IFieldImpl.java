 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.frag.Core.impl.IFieldImpl#getConstant <em>Constant</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.frag.Core.impl.IFieldImpl#getIsEnumConstant <em>Is Enum Constant</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.frag.Core.impl.IFieldImpl#getTypeSignature <em>Type Signature</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.frag.Core.impl.IFieldImpl#getIsVolatile <em>Is Volatile</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.frag.Core.impl.IFieldImpl#getIsTransient <em>Is Transient</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
