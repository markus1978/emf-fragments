...
/**
 * <!-- begin-user-doc --> 
 *   A facade for the builders for the EMF package ' <em><b>http://hu-berlin.de/sam/emfhbase/testmodel</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class TestmodelBuilders {
  ...
  public static final TestObjectBuilder newTestObjectBuilder() {
    return TestObjectBuilder.newTestObjectBuilder();
  }

  /**
   * Creates a new <em><b>TestObjectBuilder</b></em> initialized with an existing <em><b>  
  
  de.hub.emffrag.testmodels.frag.testmodel.TestObject
