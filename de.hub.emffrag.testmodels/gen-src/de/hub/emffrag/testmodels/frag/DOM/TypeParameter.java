 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.frag.DOM.TypeParameter#getName <em>Name</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.frag.DOM.TypeParameter#getTypeBounds <em>Type Bounds</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.frag.DOM.DOMPackage#getTypeParameter()
 * @model
 * @generated
 */
public interface TypeParameter extends ASTNode {
	 ...
	 * @see de.hub.emffrag.testmodels.frag.DOM.DOMPackage#getTypeParameter_Name()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.frag.DOM.TypeParameter#getName <em>Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.hub.emffrag.testmodels.frag.DOM.DOMPackage#getTypeParameter_TypeBounds()
