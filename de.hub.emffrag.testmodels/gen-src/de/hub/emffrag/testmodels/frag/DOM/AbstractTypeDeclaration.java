 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.frag.DOM.AbstractTypeDeclaration#getBodyDeclarations <em>Body Declarations</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.frag.DOM.AbstractTypeDeclaration#getName <em>Name</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.frag.DOM.AbstractTypeDeclaration#getLocalTypeDeclaration <em>Local Type Declaration</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.frag.DOM.AbstractTypeDeclaration#getMemberTypeDeclaration <em>Member Type Declaration</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.frag.DOM.AbstractTypeDeclaration#getPackageMemberTypeDeclaration <em>Package Member Type Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.frag.DOM.DOMPackage#getAbstractTypeDeclaration()
 * @model abstract="true"
 * @generated
 */
public interface AbstractTypeDeclaration extends BodyDeclaration {
	 ...
	 * The list contents are of type {@link de.hub.emffrag.testmodels.frag.DOM.BodyDeclaration}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.emffrag.testmodels.frag.DOM.DOMPackage#getAbstractTypeDeclaration_BodyDeclarations()
	 ...
	 * @see de.hub.emffrag.testmodels.frag.DOM.DOMPackage#getAbstractTypeDeclaration_Name()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.frag.DOM.AbstractTypeDeclaration#getName <em>Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.hub.emffrag.testmodels.frag.DOM.DOMPackage#getAbstractTypeDeclaration_LocalTypeDeclaration()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.frag.DOM.AbstractTypeDeclaration#getLocalTypeDeclaration <em>Local Type Declaration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.hub.emffrag.testmodels.frag.DOM.DOMPackage#getAbstractTypeDeclaration_MemberTypeDeclaration()
	 * @model unique="false" dataType="de.hub.emffrag.testmodels.frag.PrimitiveTypes.Boolean" required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.frag.DOM.AbstractTypeDeclaration#getMemberTypeDeclaration <em>Member Type Declaration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.hub.emffrag.testmodels.frag.DOM.DOMPackage#getAbstractTypeDeclaration_PackageMemberTypeDeclaration()
	 * @model unique="false" dataType="de.hub.emffrag.testmodels.frag.PrimitiveTypes.Boolean" required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.frag.DOM.AbstractTypeDeclaration#getPackageMemberTypeDeclaration <em>Package Member Type Declaration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
