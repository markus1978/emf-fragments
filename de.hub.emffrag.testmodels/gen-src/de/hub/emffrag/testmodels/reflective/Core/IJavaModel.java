 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.Core.IJavaModel#getJavaProjects <em>Java Projects</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.Core.IJavaModel#getExternalPackageFragmentRoots <em>External Package Fragment Roots</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.reflective.Core.CorePackage#getIJavaModel()
 * @model
 * @generated
 */
public interface IJavaModel extends PhysicalElement {
	 ...
	 * @see de.hub.emffrag.testmodels.reflective.Core.CorePackage#getIJavaModel_JavaProjects()
	 ...
	 * @see de.hub.emffrag.testmodels.reflective.Core.CorePackage#getIJavaModel_ExternalPackageFragmentRoots()
	 * @model containment="true" resolveProxies="true"
	 * @generated
	 */
