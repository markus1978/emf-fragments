 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.Core.IJavaProject#getPackageFragmentRoots <em>Package Fragment Roots</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.Core.IJavaProject#getExternalPackageFragmentRoots <em>External Package Fragment Roots</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.Core.IJavaProject#getRequiredProjects <em>Required Projects</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.reflective.Core.CorePackage#getIJavaProject()
 * @model
 * @generated
 */
public interface IJavaProject extends IJavaElement, PhysicalElement {
	 ...
	 * The list contents are of type {@link de.hub.emffrag.testmodels.reflective.Core.IPackageFragmentRoot}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.emffrag.testmodels.reflective.Core.CorePackage#getIJavaProject_PackageFragmentRoots()
	 ...
	 * @see de.hub.emffrag.testmodels.reflective.Core.CorePackage#getIJavaProject_ExternalPackageFragmentRoots()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link de.hub.emffrag.testmodels.reflective.Core.IJavaProject}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.emffrag.testmodels.reflective.Core.CorePackage#getIJavaProject_RequiredProjects()
	 * @model
	 * @generated
	 */
