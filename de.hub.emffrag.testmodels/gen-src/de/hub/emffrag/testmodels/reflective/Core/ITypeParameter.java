 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.Core.ITypeParameter#getBounds <em>Bounds</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.reflective.Core.CorePackage#getITypeParameter()
 * @model
 * @generated
 */
public interface ITypeParameter extends IJavaElement, ISourceReference {
	 ...
	 * @see de.hub.emffrag.testmodels.reflective.Core.CorePackage#getITypeParameter_Bounds()
