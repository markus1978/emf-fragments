 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.Name#getFullyQualifiedName <em>Fully Qualified Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.reflective.DOM.DOMPackage#getName_()
 * @model abstract="true"
 * @generated
 */
public interface Name extends Expression {
	 ...
	 * @see de.hub.emffrag.testmodels.reflective.DOM.DOMPackage#getName_FullyQualifiedName()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.reflective.DOM.Name#getFullyQualifiedName <em>Fully Qualified Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
