 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.AST#getCompilationUnits <em>Compilation Units</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.reflective.DOM.DOMPackage#getAST()
 * @model
 * @generated
 */
public interface AST extends EObject {
	 ...
	 * @see de.hub.emffrag.testmodels.reflective.DOM.DOMPackage#getAST_CompilationUnits()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.reflective.DOM.AST#getCompilationUnits <em>Compilation Units</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
