 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.impl.ModifierImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.impl.ModifierImpl#getFinal <em>Final</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.impl.ModifierImpl#getNative <em>Native</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.impl.ModifierImpl#getNone <em>None</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.impl.ModifierImpl#getPrivate <em>Private</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.impl.ModifierImpl#getProtected <em>Protected</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.impl.ModifierImpl#getPublic <em>Public</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.impl.ModifierImpl#getStatic <em>Static</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.impl.ModifierImpl#getStrictfp <em>Strictfp</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.impl.ModifierImpl#getSynchronized <em>Synchronized</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.impl.ModifierImpl#getTransient <em>Transient</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.impl.ModifierImpl#getVolatile <em>Volatile</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
