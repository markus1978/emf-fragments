 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.Expression#getResolveBoxing <em>Resolve Boxing</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.Expression#getResolveUnboxing <em>Resolve Unboxing</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.reflective.DOM.Expression#getTypeBinding <em>Type Binding</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.reflective.DOM.DOMPackage#getExpression()
 * @model abstract="true"
 * @generated
 */
public interface Expression extends ASTNode {
	 ...
	 * @see de.hub.emffrag.testmodels.reflective.DOM.DOMPackage#getExpression_ResolveBoxing()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.reflective.DOM.Expression#getResolveBoxing <em>Resolve Boxing</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.hub.emffrag.testmodels.reflective.DOM.DOMPackage#getExpression_ResolveUnboxing()
	 * @model unique="false" dataType="de.hub.emffrag.testmodels.reflective.PrimitiveTypes.Boolean" required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.reflective.DOM.Expression#getResolveUnboxing <em>Resolve Unboxing</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.hub.emffrag.testmodels.reflective.DOM.DOMPackage#getExpression_TypeBinding()
	...
	/**
	 * Sets the value of the '{@link de.hub.emffrag.testmodels.reflective.DOM.Expression#getTypeBinding <em>Type Binding</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
