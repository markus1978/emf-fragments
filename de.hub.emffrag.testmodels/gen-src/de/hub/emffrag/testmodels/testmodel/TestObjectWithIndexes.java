 ...
 * <ul>
 *   <li>{@link de.hub.emffrag.testmodels.testmodel.TestObjectWithIndexes#getIndexedReferences <em>Indexed References</em>}</li>
 *   <li>{@link de.hub.emffrag.testmodels.testmodel.TestObjectWithIndexes#getIndexedContents <em>Indexed Contents</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.emffrag.testmodels.testmodel.frag.meta.TestModelPackage#getTestObjectWithIndexes()
 * @model
 * @generated
 */
public interface TestObjectWithIndexes extends TestObject {
	 ...
	 * @see de.hub.emffrag.testmodels.testmodel.frag.meta.TestModelPackage#getTestObjectWithIndexes_IndexedReferences()
	 ...
	 * @see de.hub.emffrag.testmodels.testmodel.frag.meta.TestModelPackage#getTestObjectWithIndexes_IndexedContents()
