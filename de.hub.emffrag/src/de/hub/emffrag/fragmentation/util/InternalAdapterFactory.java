...
public class InternalAdapterFactory extends AdapterFactoryImpl {
	...
	protected InternalSwitch<Adapter> modelSwitch =
		new InternalSwitch<Adapter>() {
			@Override
			public Adapter caseFInternalObject(FInternalObject object) {
				return createFInternalObjectAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hub.emffrag.fragmentation.FInternalObject <em>FInternal Object</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFInternalObjectAdapter() {
		return null;
	}
