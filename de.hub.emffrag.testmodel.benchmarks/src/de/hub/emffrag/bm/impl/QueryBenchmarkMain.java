...
public class QueryBenchmarkMain extends LoadBenchmarkMain {
    ...
    protected Benchmark createBuilder(boolean frag2, int model) {
        return BenchmarkBuilders.newQueryBenchmarkBuilder().
                withPModelName("testmodel" +( frag2? "_f2":"") + "_" + model).
    ...
    public Measurement getMeasurement() {
        return MeasurementBuilder.newMeasurementBuilder().
                ...
                withBenchmarks(super.createBuilder(false, 0)).
                withBenchmarks(super.createBuilder(true, 0)).
                withBenchmarks(createBuilder(false, 1)).
                withBenchmarks(createBuilder(true, 1)).
                withBenchmarks(super.createBuilder(false, 1)).
                withBenchmarks(super.createBuilder(true, 1)).
                withBenchmarks(createBuilder(false, 2)).
                withBenchmarks(createBuilder(true, 2)).
                withBenchmarks(super.createBuilder(false, 2)).
                withBenchmarks(super.createBuilder(true, 2)).
                withBenchmarks(createBuilder(false, 3)).
                withBenchmarks(createBuilder(true, 3)).
                withBenchmarks(super.createBuilder(false, 3)).
                withBenchmarks(super.createBuilder(true, 3)).
                withBenchmarks(createBuilder(false, 4)).
                withBenchmarks(createBuilder(true, 4)).
                withBenchmarks(super.createBuilder(false, 4)).
                withBenchmarks(super.createBuilder(true, 4)).
