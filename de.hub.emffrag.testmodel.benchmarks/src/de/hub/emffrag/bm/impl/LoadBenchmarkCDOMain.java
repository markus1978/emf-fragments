...
public class LoadBenchmarkCDOMain extends BenchmarkMain {
    ...
    protected Benchmark createBuilder(int model) {
    ...
    protected Benchmark createQueryBuilder(int model) {
        return BenchmarkBuilders.newQueryBenchmarkBuilder().
                withPModelName("testmodel_" + model).
                withPSourceXmiURI("../de.hub.emffrag.testmodel/models/set" + model + ".xmi").
                withRemarks("CDO").build();
    }
    
    protected String getName() {
    	return "results/CDOFragOnMac_23_1";
    }
    ...
    public Measurement getMeasurement() {
        return MeasurementBuilder.newMeasurementBuilder().
                withName(getName()).
                withBenchmarks(createQueryBuilder(0)). 
                withBenchmarks(createBuilder(0)).
                withBenchmarks(createQueryBuilder(1)). 
                withBenchmarks(createBuilder(1)).
                withBenchmarks(createQueryBuilder(2)). 
                withBenchmarks(createBuilder(2)).                                
                withCandidates(EMFFragCandidates.CDO).
                withRuns(20).build();
    }
    
    public static void main(String[] args) {
        new LoadBenchmarkCDOMain().run(args);
    }
}
